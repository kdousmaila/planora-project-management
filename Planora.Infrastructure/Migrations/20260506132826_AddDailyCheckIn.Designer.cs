...
namespace Planora.Infrastructure.Migrations
{
    ...
    [Migration("20260506132826_AddDailyCheckIn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetingEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MeetingPinnedMessage", b =>
                {
                    b.Property<Guid>("MeetingEventId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PinnedMessageId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("MeetingEventId", "PinnedMessageId");

                    b.HasIndex("PinnedMessageId");

                    b.ToTable("MeetingPinnedMessage");
                });
            ...
            modelBuilder.Entity("Planora.Domain.Entities.DailyCheckIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "ProjectId", "CheckedAt");
            ...
            modelBuilder.Entity("MeetingPinnedMessage", b =>
                {
                    b.HasOne("MeetingEvent", null)
                        .WithMany("PinnedMessages")
                        .HasForeignKey("MeetingEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PinnedMessage", "PinnedMessage")
                        .WithMany()
