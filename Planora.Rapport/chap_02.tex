...
La figure \ref{fig:GestionUtilisateurUseCase} ci-dessous illustre le diagramme de raffinement de la gestion des utilisateurs et de l'authentification.

\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/GestionUtilisateurUseCase.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/GestionWorkspaceUseCase.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/GestionProjetUseCase.png}
...
\begin{longtable}[c]{|p{0.3\linewidth}|p{0.65\linewidth}|}
  ...
  \textbf{Objectif}      & Permettre la création, la modification et le suivi des projets.                   \\
  \hline
  \textbf{Acteur(s)}     & Administrateur, ProjectManager, Membre                                            \\
  \hline
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/GestionBacklogSprintUseCase.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/GestionCollaborationUseCase.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\columnwidth]{img/TeamHealthUseCase.png}
