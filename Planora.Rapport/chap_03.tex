...
\begin{itemize}
  \item[$\bullet$] \textbf{Classe "ApplicationUser"} : Représente l'utilisateur de l'application. Elle hérite de la classe IdentityUser et contient les informations personnelles de l'utilisateur, son état d'activation, son jeton de rafraîchissement ainsi que ses relations avec les projets, les espaces de travail, les tâches, les commentaires, les messages et les sessions de discussion.
  ...
  \item[$\bullet$] \textbf{Classe "WorkspaceUser"} : Représente l'association entre un utilisateur et un espace de travail. Elle contient l'identifiant de l'utilisateur, l'identifiant de l'espace de travail et la date d'adhésion.

  \item[$\bullet$] \textbf{Classe "WorkspaceInvitation"} : Représente une invitation envoyée à un utilisateur pour rejoindre un espace de travail. Elle contient l'email de l'invité, le token, la date d'expiration, l'état d'acceptation et le rôle proposé.
  ...
  \item[$\bullet$] \textbf{Classe "ProjectUser"} : Représente l'association entre un utilisateur et un projet. Elle contient l'identifiant du projet, l'identifiant de l'utilisateur et la date d'affectation.

  \item[$\bullet$] \textbf{Classe "ProjectInvitation"} : Représente une invitation envoyée à un utilisateur pour rejoindre un projet. Elle contient l'utilisateur invité, l'utilisateur émetteur, la date d'expiration, la date de réponse et l'état d'acceptation.
  ...
  \item[$\bullet$] \textbf{Classe "ChatMessageReaction"} : Représente une réaction à un message. Elle contient l'utilisateur, le message concerné et l'emoji utilisé.
  ...
  \item[$\bullet$] \textbf{Classe "PinnedMessage"} : Représente un message épinglé dans un projet. Elle contient le contenu du message, une note éventuelle, l'utilisateur qui l'a épinglé et la date d'épinglage.
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/DiagrammeClasseGeneral.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/GestionAuthentificationSequence.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/GestionWorkspaceProjetSequence.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/GestionBacklogSprintSequence.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/GestionCollaborationSequence.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=1\linewidth]{img/TeamHealthSequence.png}
