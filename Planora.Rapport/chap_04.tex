...
\subsection{Postman}
Postman, développé par Postdot Technologies en 2012, est une plateforme de développement et de test d'API. Cet outil offre une interface intuitive et un ensemble de fonctionnalités pour simplifier la création, le test et le débogage des API. \cite{Postman}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.15\columnwidth]{postman-icon.png}
...
Afin de tester efficacement les fonctionnalités de l'application et assurer son bon fonctionnement, nous avons adopté l'utilisation de Postman.\\
La figure \ref{fig:PostManTestKeycloak} illustre le processus d'envoi d'une requête depuis Postman vers l'application pour tester ses points d'accès.
\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{PostManTestKeycloak.png}
  \caption{Processus de test des points d'accès sécurisés par Keycloak}
  \label{fig:PostManTestKeycloak}
\end{figure}
...
Dans cette section, nous présentons les incréments réalisés sprint par sprint, en détaillant le backlog associé à chaque itération ainsi que les interfaces livrées. Le découpage respecte les dépendances fonctionnelles du projet : d'abord l'authentification et la gestion des utilisateurs, ensuite les espaces de travail et les projets, puis la gestion agile, la collaboration, et enfin le module d'intelligence artificielle dédié au suivi de la santé de l'équipe.

\subsection{Sprint 1 - Authentification et gestion des utilisateurs}
...
\begin{longtable}{|p{5.8cm}|p{1.3cm}|p{7.2cm}|}
  \caption{Backlog du Sprint 1 : Authentification et gestion des utilisateurs}\label{tab:backlog-sprint1}              \\
  \hline
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint1-login.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint1-register.png}
...
\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint1-users.png}
  \caption{Sprint 1 - Interface de gestion des utilisateurs}
  \label{fig:sprint1-users}
\end{figure}

\subsection{Sprint 2 - Gestion des espaces de travail et des projets}
\subsubsection{Backlog du sprint}
Le tableau \ref{tab:backlog-sprint2} illustre le backlog du Sprint 2.

\begin{longtable}{|p{5.8cm}|p{1.3cm}|p{7.2cm}|}
  \caption{Backlog du Sprint 2 : Gestion des espaces de travail et des projets}\label{tab:backlog-sprint2}                            \\
  \hline
  \textbf{User Story} & \textbf{ID} & \textbf{Tâches}                                                                                 \\
  \hline
  \endfirsthead
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant qu'administrateur, je veux créer des espaces de travail afin d'organiser les équipes et les projets.\end{minipage}}
                      & 2.1         & \textbullet~Créer l'entité Workspace et ses relations.                                          \\
  \cline{2-3}
                      & 2.2         & \textbullet~Développer les API de création, consultation et suppression des espaces de travail. \\
  \cline{2-3}
                      & 2.3         & \textbullet~Créer les interfaces de gestion des espaces de travail.                             \\
  \hline

  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant qu'administrateur ou ProjectManager, je veux inviter des membres afin de constituer une équipe de travail.\end{minipage}}
                      & 2.4         & \textbullet~Mettre en place le système d'invitations aux espaces de travail.                    \\
  \cline{2-3}
                      & 2.5         & \textbullet~Permettre l'acceptation et le refus des invitations.                                \\
  \cline{2-3}
                      & 2.6         & \textbullet~Afficher la liste des membres d'un espace de travail.                               \\
  \hline

  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que ProjectManager, je veux créer et gérer des projets afin de suivre leur avancement.\end{minipage}}
                      & 2.7         & \textbullet~Créer l'entité Project et ses relations avec Workspace et ApplicationUser.          \\
  \cline{2-3}
                      & 2.8         & \textbullet~Développer les API de création, modification et consultation des projets.           \\
  \cline{2-3}
                      & 2.9         & \textbullet~Créer les interfaces de liste et de détail des projets.                             \\
  \hline
\end{longtable}

\subsubsection{Interfaces livrables}

La figure \ref{fig:sprint2-workspaces} illustre l'interface de consultation des espaces de travail accessibles à l'utilisateur.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint2-workspaces.png}
  \caption{Sprint 2 - Interface des espaces de travail}
  \label{fig:sprint2-workspaces}
\end{figure}

La figure \ref{fig:sprint2-projects} présente l'interface de gestion des projets.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint2-projects.png}
  \caption{Sprint 2 - Interface de gestion des projets}
  \label{fig:sprint2-projects}
\end{figure}

\subsection{Sprint 3 - Gestion agile : backlog, tâches et sprints}
\subsubsection{Backlog du sprint}
Le tableau \ref{tab:backlog-sprint3} illustre le backlog du Sprint 3.

\begin{longtable}{|p{5.8cm}|p{1.3cm}|p{7.2cm}|}
  \caption{Backlog du Sprint 3 : Gestion agile}\label{tab:backlog-sprint3}                                                                    \\
  \hline
  \textbf{User Story} & \textbf{ID} & \textbf{Tâches}                                                                                         \\
  \hline
  \endfirsthead
  ...
  \multirow{4}{*}{\begin{minipage}[t]{5.8cm}En tant que ProjectManager, je veux gérer le backlog afin d'organiser les besoins du projet.\end{minipage}}
                      & 3.1         & \textbullet~Créer l'entité BacklogItem et ses relations.                                                \\
  \cline{2-3}
                      & 3.2         & \textbullet~Développer les opérations de création, modification et suppression des éléments du backlog. \\
  \cline{2-3}
                      & 3.3         & \textbullet~Ajouter la priorité, la complexité, les story points et la date d'échéance.                 \\
  \cline{2-3}
                      & 3.4         & \textbullet~Permettre l'affectation des éléments du backlog aux membres.                                \\
  \hline
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que membre, je veux suivre mes tâches afin de connaître mon travail à réaliser.\end{minipage}}
                      & 3.5         & \textbullet~Créer la gestion des tâches et des sous-tâches.                                             \\
  \cline{2-3}
                      & 3.6         & \textbullet~Permettre la mise à jour de l'état et du pourcentage d'avancement.                          \\
  \cline{2-3}
                      & 3.7         & \textbullet~Ajouter les commentaires liés aux tâches et au backlog.                                     \\
  \hline
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que ProjectManager, je veux gérer les sprints afin de planifier le travail par itérations.\end{minipage}}
                      & 3.8         & \textbullet~Créer l'entité Sprint et ses relations avec Project et TaskItem.                            \\
  \cline{2-3}
                      & 3.9         & \textbullet~Développer la création et la consultation des sprints.                                      \\
  \cline{2-3}
                      & 3.10        & \textbullet~Créer le tableau de sprint pour suivre l'avancement.                                        \\
  \hline
\end{longtable}

\subsubsection{Interfaces livrables}

La figure \ref{fig:sprint3-backlog} illustre l'interface de gestion du backlog.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint3-backlog.png}
  \caption{Sprint 3 - Interface de gestion du backlog}
  \label{fig:sprint3-backlog}
\end{figure}

La figure \ref{fig:sprint3-board} présente le tableau agile permettant de suivre l'avancement des tâches du sprint.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint3-board.png}
  \caption{Sprint 3 - Tableau de sprint}
  \label{fig:sprint3-board}
\end{figure}
\subsection{Sprint 4 - Collaboration, réunions et tableau de bord}
\subsubsection{Backlog du sprint}
Le tableau \ref{tab:backlog-sprint4} illustre le backlog du Sprint 4.

\begin{longtable}{|p{5.8cm}|p{1.3cm}|p{7.2cm}|}
  \caption{Backlog du Sprint 4 : Collaboration et suivi}\label{tab:backlog-sprint4}                                \\
  \hline
  \textbf{User Story} & \textbf{ID} & \textbf{Tâches}                                                              \\
  \hline
  \endfirsthead
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que membre de projet, je veux échanger avec mon équipe afin de faciliter la collaboration.\end{minipage}}
                      & 4.1         & \textbullet~Créer les entités ChatSession et ChatMessage.                    \\
  \cline{2-3}
                      & 4.2         & \textbullet~Développer l'espace de messagerie par projet.                    \\
  \cline{2-3}
                      & 4.3         & \textbullet~Ajouter les réactions, réponses et pièces jointes aux messages.  \\
  \hline
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que membre de projet, je veux planifier des réunions afin d'organiser les échanges de l'équipe.\end{minipage}}
                      & 4.4         & \textbullet~Créer la gestion des événements de réunion.                      \\
  \cline{2-3}
                      & 4.5         & \textbullet~Afficher les réunions dans un calendrier.                        \\
  \cline{2-3}
                      & 4.6         & \textbullet~Permettre la sélection des membres concernés par une réunion.    \\
  \hline
  ...
  \multirow{2}{*}{\begin{minipage}[t]{5.8cm}En tant qu'utilisateur, je veux consulter un tableau de bord afin de suivre l'avancement global.\end{minipage}}
                      & 4.7         & \textbullet~Calculer les indicateurs d'avancement des projets et workspaces. \\
  \cline{2-3}
                      & 4.8         & \textbullet~Créer l'interface du tableau de bord.                            \\
  \hline
\end{longtable}

\subsubsection{Interfaces livrables}

La figure \ref{fig:sprint4-chat} illustre l'interface de messagerie du projet.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint4-chat.png}
  \caption{Sprint 4 - Interface de messagerie}
  \label{fig:sprint4-chat}
\end{figure}

La figure \ref{fig:sprint4-calendar} présente le calendrier des réunions du projet.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint4-calendar.png}
  \caption{Sprint 4 - Calendrier des réunions}
  \label{fig:sprint4-calendar}
\end{figure}

\subsection{Sprint 5 - Suivi de la santé de l'équipe par IA}
\subsubsection{Backlog du sprint}
Le tableau \ref{tab:backlog-sprint5} illustre le backlog du Sprint 5.

\begin{longtable}{|p{5.8cm}|p{1.3cm}|p{7.2cm}|}
  \caption{Backlog du Sprint 5 : Suivi de la santé de l'équipe par IA}\label{tab:backlog-sprint5}                               \\
  \hline
  \textbf{User Story} & \textbf{ID} & \textbf{Tâches}                                                                           \\
  \hline
  \endfirsthead
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que ProjectManager, je veux analyser les messages de l'équipe afin de détecter l'ambiance générale du projet.\end{minipage}}
                      & 5.1         & \textbullet~Préparer le modèle d'analyse des sentiments.                                  \\
  \cline{2-3}
                      & 5.2         & \textbullet~Développer l'\ac{API} Flask d'analyse des messages.                           \\
  \cline{2-3}
                      & 5.3         & \textbullet~Connecter le module IA à la base de données et aux messages du projet.        \\
  \hline
  ...
  \multirow{3}{*}{\begin{minipage}[t]{5.8cm}En tant que membre ou ProjectManager, je veux consulter les indicateurs de santé de l'équipe afin d'identifier les situations à risque.\end{minipage}}
                      & 5.4         & \textbullet~Classifier les messages en positif, neutre, stressé ou frustré.               \\
  \cline{2-3}
                      & 5.5         & \textbullet~Calculer un score global de santé de l'équipe.                                \\
  \cline{2-3}
                      & 5.6         & \textbullet~Afficher la distribution des sentiments, les alertes et le résumé par membre. \\
  \hline
\end{longtable}

\subsubsection{Interfaces livrables}

La figure \ref{fig:sprint5-dashboard} illustre l'interface de Dashboard

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint5-dashboard.png}
  \caption{Sprint 5 - Interface de tableau de bord}
  \label{fig:sprint5-dashboard}
\end{figure}

La figure \ref{fig:sprint5-teamhealth} illustre l'interface de suivi de la santé de l'équipe.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint5-teamhealth.png}
  \caption{Sprint 5 - Interface de suivi de la santé de l'équipe}
  \label{fig:sprint5-teamhealth}
\end{figure}

La figure \ref{fig:sprint5-ai-health} présente le résultat de test de l'API Flask dédiée à l'analyse des sentiments.

\begin{figure}[H]
  \centering
  % \includegraphics[width=0.9\columnwidth]{img/sprint5-ai-health.png}
  \caption{Sprint 5 - Test du service IA d'analyse des sentiments}
  \label{fig:sprint5-ai-health}
\end{figure}

\section*{Conclusion}
Dans ce chapitre, nous avons présenté l'environnement logiciel, suivi de la mise en évidence de l'architecture technique des différentes couches de l'application. Enfin, nous avons détaillé les interfaces réalisées, accompagnés des captures d'écran et des test des services implémenté.
